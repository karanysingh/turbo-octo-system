...
LOAD DATA LOCAL INFILE '~/Documents/Github/ringover/migration/UEFA.PLAYER_INFO.csv' INTO TABLE players_info FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 LINES (player_name, club);
LOAD DATA LOCAL INFILE '~/Documents/Github/ringover/migration/UEFA.PLAYER_INFO.csv' INTO TABLE key_stats FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 LINES (player_name, club, position, minutes_played, match_played, goals, assists, distance_covered);
LOAD DATA LOCAL INFILE '~/Documents/Github/ringover/migration/attacking.csv' INTO TABLE attacking FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 LINES (serial, player_name,club, position, assists, corner_taken, offsides, dribbles, match_played);
LOAD DATA LOCAL INFILE '~/Documents/Github/ringover/migration/defending.csv' INTO TABLE defending FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 LINES (serial, player_name, club, position, balls_recoverd, tackles, t_won, t_lost, clearance_attempted, match_played);
LOAD DATA LOCAL INFILE '~/Documents/Github/ringover/migration/attempts.csv' INTO TABLE attempts FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 LINES (serial, player_name, club, position, total_attempts, on_target, off_target, blocked, match_played);
LOAD DATA LOCAL INFILE '~/Documents/Github/ringover/migration/disciplinary.csv' INTO TABLE disciplinary FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 LINES (serial, player_name, club, position, fouls_committed, fouls_suffered, red, yellow, minutes_played, match_played);
LOAD DATA LOCAL INFILE '~/Documents/Github/ringover/migration/distributon.csv' INTO TABLE distribution FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 LINES (serial, player_name, club, position, pass_accuracy, pass_attempted, pass_completed, cross_accuracy, cross_attempted, cross_completed);
LOAD DATA LOCAL INFILE '~/Documents/Github/ringover/migration/goalkeeping.csv' INTO TABLE goalkeeping FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 LINES (serial, player_name, club, position, saved, conceded, saved_penalties, cleansheets, punches_made, match_played);
LOAD DATA LOCAL INFILE '~/Documents/Github/ringover/migration/goals.csv' INTO TABLE goals FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' IGNORE 1 LINES (serial, player_name, club, position, goals, right_foot, left_foot, headers, others, inside_area);
